                                ...
                                {orders && orders.map((order, index) => (
                                    <tr key={order._id} className="hover:bg-blueGray-100">
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center ">
                                            ...
                                            className='bg-sky-500 text-white px-2 py-1 rounded-md hover:bg-sky-600 duration-500'
                                            >View Order</Link>
                                        </td>
                                    </tr>
                                ))}
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                            <div className="text-sm text-blueGray-500 font-semibold py-1">
                                Made with <a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank" rel="noopener noreferrer">Tailwind CSS</a> by <a href="https://www.creative-tim.com" className="text-blueGray-500 hover:text-blueGray-800" target="_blank" rel="noopener noreferrer"> Jihad</a>.
                            </div>
                        </div>
                    </div>
                </div>
