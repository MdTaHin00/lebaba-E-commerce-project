...
function UserReviews() {
  ...
  const { data, isLoading } = useGetReviewsByUserIdQuery(user?._id)
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-4 text-sky-400">Your Given Reviews</h1>
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3">
        ...
        <div
          className="bg-gray-100 text-black flex items-center justify-center rounded-lg p-6 border border-gray-200 cursor-pointer hover:bg-sky-300 hover:text-white transition-all duration-200"
